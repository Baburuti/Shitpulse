...
module.exports = function salchyarcanepulse(mod) {
	...
	mod.command.add('fuck', () => {

		options.enabled = !options.enabled
		mod.command.message(`Fucking exploit is now ${(options.enabled) ? 'en' : 'dis'}abled.`)
